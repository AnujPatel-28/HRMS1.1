-- Migration: Transactional Employee Creation RPC
-- This migration introduces the transactional employee creation RPC that groups employee creation, onboarding seeding, reporting relationships, leave balances seeding, and audit logs.
...
BEGIN
  ...
  -- Employee code uniqueness (if provided and not empty)
  ...
  -- 5. Manager Cycle Loop Validations
  -- Match tenant for managers if provided.
  ...
  -- 8. Seed onboarding self progress row
  ...
  -- 10. Seed secondary relationship
  IF p_secondary_manager_id IS NOT NULL THEN
    INSERT INTO public.employee_reporting_relationships (
      tenant_id,
      employee_id,
