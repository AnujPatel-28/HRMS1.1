...
async function main() {
  ...
  try {
    console.log("Reading seed-leaves-projects.sql file...");
    const sql = fs.readFileSync("scratch/seed-leaves-projects.sql", "utf-8");
    
    console.log("Running seeding SQL script...");
    await client.query(sql);
    
    console.log("✓ Leaves and Project tasks successfully seeded on the branched database!");
  } catch (err) {
