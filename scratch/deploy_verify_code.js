...
async function runDeploy() {
  return new Promise((resolve, reject) => {
    ...
    async function runFlow() {
      ...
      console.log("Calling update-function for verify-employee-code on preview branch...");
      const callRes = await callMethod("tools/call", {
        name: "update-function",
        arguments: {
          slug: "verify-employee-code",
          codeFile: "c:\\Users\\Anuj\\Desktop\\hrms\\HRMS-Talentmesh-Solutions\\functions\\verify-employee-code.ts"
        }
      });
